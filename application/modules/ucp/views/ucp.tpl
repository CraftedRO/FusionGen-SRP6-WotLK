<section id="ucp_top">
	<a href="{$url}ucp/avatar" id="ucp_avatar">
		...
		<img src="{$url}application/themes/default/images/avatars/0_normal.jpg"/>
	</a>
	...
	<section id="ucp_info">
		<aside>
			<table width="100%">
				...
				<tr>
					<td width="10%"><img src="{$url}application/images/icons/expansion.png"/></td>
				...
				<tr>
					<td width="10%"><img src="{$url}application/images/icons/rank.png"/></td>
