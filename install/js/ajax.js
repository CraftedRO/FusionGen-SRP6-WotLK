		...
		addRealm: function(form)
		{
			UI.confirm('<input type="text" id="realmname_preserve" placeholder="Enter the realmname" autofocus/>', 'Add', function()
			{
				...
				if ( ! name)
					...
					$("#realm_field").append("<div class=\"realmHeader\"><a onclick='Ajax.Realms.show(this);'><img class='realmExtend' src='images/button_drop.png'/> " + name + "</a> <img class='realmDelete' src='images/button_delete.png' onclick='Ajax.Realms.deleteRealm(this);'/></div><div class='realmForm' style='display: none;'></div>");
